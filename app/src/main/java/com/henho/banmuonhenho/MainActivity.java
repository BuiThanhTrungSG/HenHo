...
import com.henho.banmuonhenho.Adapter.Fragment_adapter;
import com.henho.banmuonhenho.Model.Model_tinnhanmoi;
...
public class MainActivity extends AppCompatActivity implements MaxAdListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // tạo menu
        BottomNavigationView_trangchu.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            @Override
...
// Kiểm tra xem quay lại từ trang tin nhắn thì hiện fragment tin nhắn luôn xong
    ...
    private void xuly_viewpager () {
        Fragment_adapter fragment_adapter = new Fragment_adapter(getSupportFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
            ...
            public void onPageSelected(int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        BottomNavigationView_trangchu.getMenu().findItem(R.id.menu_phongchat).setChecked(true);
                        break;
                    case 2:
    ...
    public void onBackPressed() {
        if(BottomNavigationView_trangchu.getMenu().findItem(R.id.menu_tinhan).isChecked()||BottomNavigationView_trangchu.getMenu().findItem(R.id.menu_canhan).isChecked()|| BottomNavigationView_trangchu.getMenu().findItem(R.id.menu_phongchat).isChecked()){
            viewPager.setCurrentItem(0);
        }else {
