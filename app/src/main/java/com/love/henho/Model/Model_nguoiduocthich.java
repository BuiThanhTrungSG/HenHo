...
public class Model_nguoiduocthich {
    ...
    public Model_nguoiduocthich() {
    }

    public Model_nguoiduocthich(String id_nguoigui, String loicauhon, Integer sovangsinhle, Integer ngaygui) {
